...
# port_status_enum, pon_type_enum). Padrão de uso quando for preciso:
...
"""Pontos importantes:
-`create_type=False`: impede o SQLAlchemy de tentar recriar o tipo (o DDL já criou; recriar daria erro).
- `values_callable`: garante que o que vai para o banco é a STRING do enum ("online"), e não o nome do membro Python ("ONLINE").
